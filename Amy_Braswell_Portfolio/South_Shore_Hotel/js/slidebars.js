...
( function ( $ ) {
      ...
      $( '#js-open-left-slidebar-3' ).on( 'click', function ( event ) {
       ...
       $( '#js-open-left-slidebar-4' ).on( 'click', function ( event ) {
        ...
        controller.open( 'slidebar-9' );
                  ...
                  $( '#js-open-left-slidebar-10' ).on( 'click', function ( event ) {
        event.stopPropagation();
        controller.open( 'slidebar-10' );
    } );

           $( '#js-open-left-slidebar-11' ).on( 'click', function ( event ) {
        event.stopPropagation();
        controller.open( 'slidebar-11' );
    } );

            $( '#js-open-left-slidebar-12' ).on( 'click', function ( event ) {
        event.stopPropagation();
    ...
    $( '#js-close-left-slidebar-9' ).on( 'click', function ( event ) {
     ...
     $( '#js-close-left-slidebar-10' ).on( 'click', function ( event ) {
        event.stopPropagation();
        controller.close( 'slidebar-10' );
    } );

    $( '#js-close-left-slidebar-11' ).on( 'click', function ( event ) {
        event.stopPropagation();
        controller.close( 'slidebar-11' );
    } );

    $( '#js-close-left-slidebar-12' ).on( 'click', function ( event ) {
        event.stopPropagation();
